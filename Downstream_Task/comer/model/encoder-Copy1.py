...
class Encoder(pl.LightningModule):
    def __init__(self, d_model: int, growth_rate: int, num_layers: int):
        ...
        self.model.load_state_dict(torch.load('/workspace/nemo/data/RESEARCH/HMER_CoMER/CoMER/comer/model/MoCo_Backbone_DenseNet_Bottleneck.pth'),strict=False)
        
        print('Model Loaded Successfully...')
        for param in self.model.parameters():
            param.requires_grad=True
        print('Model Weights are Trainable..')    
